...
void Quicksort(int a[], int primero, int ultimo);//Recursividad
...
void menu(){
	int a[10], num, i, x, y, opcion;

	do{
		printf("\t MENU\n");
		printf("1. Burbuja\n");
		printf("2. Seleccioanr\n");
		printf("3. Insersion\n");
		printf("4. Burbuja2\n");
		printf("5. Seleccioanr2\n");
		printf("6. Shell\n");
		printf("7. Quicksort sin recursividad\n");
		printf("8. Quicksort con recursividad\n");
		printf("9. Bucketsort\n");
		printf("10. Salir\n");
		printf("Nota: El Bucketsort solo acepta numeros menores a 90\n");
		printf("Opcion:	");
		scanf("%d", &opcion);
		switch(opcion){
			case 1:
